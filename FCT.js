...
function Welcome_textRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Welcome_textComponents)
...
function HealthInstruction1_1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of HealthInstruction1_1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function HealthInstruction2_1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of HealthInstruction2_1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function HealthInstruction3_1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of HealthInstruction3_1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function trials_health1LoopBegin(trials_health1LoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisTrials_health1 of trials_health1) {
...
function trials_tasteLoopBegin(trials_tasteLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTrials_taste of trials_taste) {
...
function trials_health2LoopBegin(trials_health2LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTrials_health2 of trials_health2) {
...
function trials_choiceLoopBegin(trials_choiceLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTrials_choice of trials_choice) {
...
function FixationHealth1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of FixationHealth1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function FoodImageHealth1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of FoodImageHealth1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function WrongKeyHealth1RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of WrongKeyHealth1Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function RemainderImageHealth1RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of RemainderImageHealth1Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function TooLateHealth1RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of TooLateHealth1Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function EndOfBlock_health_1RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of EndOfBlock_health_1Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function TasteInstruction1RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of TasteInstruction1Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function TasteInstruction2RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of TasteInstruction2Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function TasteInstruction3RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of TasteInstruction3Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function FixationTasteRoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of FixationTasteComponents)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function FoodImageTasteRoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of FoodImageTasteComponents)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function WrongKeyTasteRoutineBegin(snapshot) {
      return async function () {
        ...
        for (const thisComponent of WrongKeyTasteComponents)
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
        return Scheduler.Event.NEXT;
      }
...
function RemainderImageTasteRoutineBegin(snapshot) {
      return async function () {
        ...
        for (const thisComponent of RemainderImageTasteComponents)
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
        return Scheduler.Event.NEXT;
      }
...
function TooLateTasteRoutineBegin(snapshot) {
      return async function () {
        ...
        for (const thisComponent of TooLateTasteComponents)
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
        return Scheduler.Event.NEXT;
      }
...
function EndOfBlock_tasteRoutineBegin(snapshot) {
      return async function () {
        ...
        for (const thisComponent of EndOfBlock_tasteComponents)
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
        return Scheduler.Event.NEXT;
      }
...
function HealthInstruction1_2RoutineBegin(snapshot) {
      return async function () {
        ...
        for (const thisComponent of HealthInstruction1_2Components)
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
        return Scheduler.Event.NEXT;
      }
...
function HealthInstruction2_2RoutineBegin(snapshot) {
      return async function () {
        ...
        for (const thisComponent of HealthInstruction2_2Components)
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
        return Scheduler.Event.NEXT;
      }
...
function HealthInstruction3_2RoutineBegin(snapshot) {
      return async function () {
        ...
        for (const thisComponent of HealthInstruction3_2Components)
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
        return Scheduler.Event.NEXT;
      }
...
function FixationHealth2RoutineBegin(snapshot) {
      return async function () {
        ...
        for (const thisComponent of FixationHealth2Components)
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
        return Scheduler.Event.NEXT;
      }
...
function FoodImageHealth2RoutineBegin(snapshot) {
      return async function () {
        ...
        for (const thisComponent of FoodImageHealth2Components)
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
        return Scheduler.Event.NEXT;
      }
...
function WrongKeyHealth2RoutineBegin(snapshot) {
        return async function () {
          ...
          for (const thisComponent of WrongKeyHealth2Components)
            if ('status' in thisComponent)
              thisComponent.status = PsychoJS.Status.NOT_STARTED;
          return Scheduler.Event.NEXT;
        }
...
function RemainderImageHealth2RoutineBegin(snapshot) {
        return async function () {
          ...
          for (const thisComponent of RemainderImageHealth2Components)
            if ('status' in thisComponent)
              thisComponent.status = PsychoJS.Status.NOT_STARTED;
          return Scheduler.Event.NEXT;
        }
...
function TooLateHealth2RoutineBegin(snapshot) {
        return async function () {
          ...
          for (const thisComponent of TooLateHealth2Components)
            if ('status' in thisComponent)
              thisComponent.status = PsychoJS.Status.NOT_STARTED;
          return Scheduler.Event.NEXT;
        }
...
function EndOfBlock_health_2RoutineBegin(snapshot) {
        return async function () {
          ...
          for (const thisComponent of EndOfBlock_health_2Components)
            if ('status' in thisComponent)
              thisComponent.status = PsychoJS.Status.NOT_STARTED;
          return Scheduler.Event.NEXT;
        }
...
function GetReferenceFoodRoutineBegin(snapshot) {
        return async function () {
          ...
          for (const thisComponent of GetReferenceFoodComponents)
            if ('status' in thisComponent)
              thisComponent.status = PsychoJS.Status.NOT_STARTED;
          return Scheduler.Event.NEXT;
        }
...
function ChoiceInstruction1RoutineBegin(snapshot) {
        return async function () {
          ...
          for (const thisComponent of ChoiceInstruction1Components)
            if ('status' in thisComponent)
              thisComponent.status = PsychoJS.Status.NOT_STARTED;
          return Scheduler.Event.NEXT;
        }
...
function ChoiceInstruction2RoutineBegin(snapshot) {
        return async function () {
          ...
          for (const thisComponent of ChoiceInstruction2Components)
            if ('status' in thisComponent)
              thisComponent.status = PsychoJS.Status.NOT_STARTED;
          return Scheduler.Event.NEXT;
        }
...
function ChoiceInstruction3RoutineBegin(snapshot) {
        return async function () {
          ...
          for (const thisComponent of ChoiceInstruction3Components)
            if ('status' in thisComponent)
              thisComponent.status = PsychoJS.Status.NOT_STARTED;
          return Scheduler.Event.NEXT;
        }
...
function FixationChoiceRoutineBegin(snapshot) {
        return async function () {
          ...
          for (const thisComponent of FixationChoiceComponents)
            if ('status' in thisComponent)
              thisComponent.status = PsychoJS.Status.NOT_STARTED;
          return Scheduler.Event.NEXT;
        }
...
function FoodImageChoiceRoutineBegin(snapshot) {
        return async function () {
          ...
          for (const thisComponent of FoodImageChoiceComponents)
            if ('status' in thisComponent)
              thisComponent.status = PsychoJS.Status.NOT_STARTED;
          return Scheduler.Event.NEXT;
        }
...
function WrongKeyChoiceRoutineBegin(snapshot) {
          return async function () {
            ...
            for (const thisComponent of WrongKeyChoiceComponents)
              if ('status' in thisComponent)
                thisComponent.status = PsychoJS.Status.NOT_STARTED;
            return Scheduler.Event.NEXT;
          }
...
function RemainderImageChoiceRoutineBegin(snapshot) {
          return async function () {
            ...
            for (const thisComponent of RemainderImageChoiceComponents)
              if ('status' in thisComponent)
                thisComponent.status = PsychoJS.Status.NOT_STARTED;
            return Scheduler.Event.NEXT;
          }
...
function TooLateChoiceRoutineBegin(snapshot) {
          return async function () {
            ...
            for (const thisComponent of TooLateChoiceComponents)
              if ('status' in thisComponent)
                thisComponent.status = PsychoJS.Status.NOT_STARTED;
            return Scheduler.Event.NEXT;
          }
...
function EndOfBlock_ChoiceRoutineBegin(snapshot) {
          return async function () {
            ...
            for (const thisComponent of EndOfBlock_ChoiceComponents)
              if ('status' in thisComponent)
                thisComponent.status = PsychoJS.Status.NOT_STARTED;
            return Scheduler.Event.NEXT;
          }
